...
public class Insert extends JFrame {
	public JButton button = new JButton("정보 추가하기");
	
	public JLabel set_FirstName = new JLabel("First Name :\t");
	public JTextField text_FirstName = new JTextField(10);
	
	public JLabel set_MiddleInit = new JLabel("Middle Init :\t");
	public JTextField text_MiddleInit = new JTextField(10);
	
	public JLabel set_LastName = new JLabel("Last Name :\t");
	public JTextField text_LastName = new JTextField(10);
	
	public JLabel set_Ssn = new JLabel("Ssn :\t\t\t\t\t\t\t\t\t\t\t\t");
	public JTextField text_Ssn = new JTextField(10);
	
	public JLabel set_Birthdate = new JLabel("Birthdate :\t\t\t");
	public JTextField text_Birthdate = new JTextField(10);
	
	public JLabel set_Address = new JLabel("Address :\t\t\t\t");
	public JTextField text_Address = new JTextField(10);
